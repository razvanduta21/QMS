export default function SubmitSocial() {
  return (
    <div className="mx-auto max-w-[1360px] py-10">
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-500">
          Postarile trebuie sa ramana publice minimum 7 zile. Recompensa: +50 SFP,
          maxim 2 postari / luna.
        </p>
      </section>
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="flex flex-col gap-2 text-xs font-semibold text-slate-500">
            <span className="uppercase tracking-[0.25em]">Post URL</span>
            <input
